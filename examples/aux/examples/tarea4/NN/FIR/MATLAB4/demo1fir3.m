...
% bp_firnet3 	 - Trains the three layer FIR network with backpropagation.
% firnet3 	 - Simulates the three layer network with internal delays.
...
% output nodes in the network. Here we arbitrarily choose 7 nodes in each
% hidden layer:
Nodes = [Ni 7 7 Ni];  % Number of nodes in each layer
...
% The second layer will use a total of 3 taps, and the third layer will use
% 2 taps.
Taps = [4 3 2];          % Number of time-delays
...
[W1,B1,W2,B2,W3,B3,mse] = bp_firnet3(W1,B1,W2,B2,W3,B3,inpT,desT,TP);
...
[pred] = firnet3(W1,B1,W2,B2,W3,B3,inpT);
