...
from deepensemble.utils import load_data_segment, Serializable
...
if not os.path.exists(file_scores):
    ...
    scores = test_classifiers(name_db, data_input, data_target, classes_labels,
                              ...
                              n_ensemble_models=3,
                              lamb_ncl=1.0,
                              beta_cip=0.4, lamb_cip=0.1, s=s, dist='CS',
                              beta_cip_kl=8, lamb_cip_kl=2,
                              fn_activation1=ActivationFunctions.sigmoid,
                              fn_activation2=ActivationFunctions.sigmoid,
                              folds=10, lr=0.01, lr_klg=0.001, max_epoch=500, batch_size=40)
